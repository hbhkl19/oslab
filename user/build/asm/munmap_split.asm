...
/home/hbh/oslab/oslab/user/build/riscv64/munmap_split:     file format elf64-littleriscv
...
0000000000001004 <test_munmap_split>:
#include "stdio.h"
#include "stdlib.h"
#include "string.h"
...
void test_munmap_split(void)
{
    ...
    100a:	f2250513          	add	a0,a0,-222 # 1f28 <__clone+0x2c>
{
    100e:	e406                	sd	ra,8(sp)
    1010:	e022                	sd	s0,0(sp)
    TEST_START(__func__);
    1012:	334000ef          	jal	1346 <puts>
    1016:	00001517          	auipc	a0,0x1
    101a:	fea50513          	add	a0,a0,-22 # 2000 <__func__.0>
    101e:	328000ef          	jal	1346 <puts>
    1022:	00001517          	auipc	a0,0x1
    1026:	f1e50513          	add	a0,a0,-226 # 1f40 <__clone+0x44>
    ...
    1032:	4689                	li	a3,2
    1034:	460d                	li	a2,3
    1036:	658d                	lui	a1,0x3
    1038:	4501                	li	a0,0
    103a:	56d000ef          	jal	1da6 <mmap>
    printf("mmap base: %p\n", base);
    103e:	85aa                	mv	a1,a0
    char *base = mmap(NULL, 3 * 4096, PROT_READ | PROT_WRITE, MAP_PRIVATE, -1, 0);
    1040:	842a                	mv	s0,a0
    ...
    1046:	f0e50513          	add	a0,a0,-242 # 1f50 <__clone+0x54>
    104a:	31e000ef          	jal	1368 <printf>
    assert(base != MAP_FAILED);
    104e:	57fd                	li	a5,-1
    1050:	08f40063          	beq	s0,a5,10d0 <test_munmap_split+0xcc>

    strcpy(base, "left-page");
    1054:	00001597          	auipc	a1,0x1
    1058:	f2c58593          	add	a1,a1,-212 # 1f80 <__clone+0x84>
    105c:	8522                	mv	a0,s0
    105e:	17d000ef          	jal	19da <strcpy>
    strcpy(base + 2 * 4096, "right-page");
    1062:	6509                	lui	a0,0x2
    1064:	00001597          	auipc	a1,0x1
    1068:	f2c58593          	add	a1,a1,-212 # 1f90 <__clone+0x94>
    106c:	9522                	add	a0,a0,s0
    106e:	16d000ef          	jal	19da <strcpy>

    int ret = munmap(base + 4096, 4096);
    1072:	6505                	lui	a0,0x1
    1074:	6585                	lui	a1,0x1
    1076:	9522                	add	a0,a0,s0
    1078:	545000ef          	jal	1dbc <munmap>
    107c:	842a                	mv	s0,a0
    printf("munmap split ret: %d\n", ret);
    107e:	85aa                	mv	a1,a0
    1080:	00001517          	auipc	a0,0x1
    1084:	f2050513          	add	a0,a0,-224 # 1fa0 <__clone+0xa4>
    1088:	2e0000ef          	jal	1368 <printf>
    assert(ret == 0);
    108c:	e81d                	bnez	s0,10c2 <test_munmap_split+0xbe>

    printf("munmap split success.\n");
    108e:	00001517          	auipc	a0,0x1
    1092:	f2a50513          	add	a0,a0,-214 # 1fb8 <__clone+0xbc>
    1096:	2d2000ef          	jal	1368 <printf>
    TEST_END(__func__);
    109a:	00001517          	auipc	a0,0x1
    109e:	f3650513          	add	a0,a0,-202 # 1fd0 <__clone+0xd4>
    10a2:	2a4000ef          	jal	1346 <puts>
    10a6:	00001517          	auipc	a0,0x1
    10aa:	f5a50513          	add	a0,a0,-166 # 2000 <__func__.0>
    10ae:	298000ef          	jal	1346 <puts>
}
    10b2:	6402                	ld	s0,0(sp)
    10b4:	60a2                	ld	ra,8(sp)
    TEST_END(__func__);
    10b6:	00001517          	auipc	a0,0x1
    10ba:	e8a50513          	add	a0,a0,-374 # 1f40 <__clone+0x44>
}
    10be:	0141                	add	sp,sp,16
    TEST_END(__func__);
    10c0:	a459                	j	1346 <puts>
    assert(ret == 0);
    10c2:	00001517          	auipc	a0,0x1
    10c6:	e9e50513          	add	a0,a0,-354 # 1f60 <__clone+0x64>
    10ca:	518000ef          	jal	15e2 <panic>
    10ce:	b7c1                	j	108e <test_munmap_split+0x8a>
    assert(base != MAP_FAILED);
    10d0:	00001517          	auipc	a0,0x1
    10d4:	e9050513          	add	a0,a0,-368 # 1f60 <__clone+0x64>
    10d8:	50a000ef          	jal	15e2 <panic>
    10dc:	bfa5                	j	1054 <test_munmap_split+0x50>
...
int main(void)
{
    ...
    test_munmap_split();
    10e2:	f23ff0ef          	jal	1004 <test_munmap_split>
    return 0;
}
    ...
    10f0:	4108                	lw	a0,0(a0)
{
	...
	exit(main(argc, argv));
    10f4:	05a1                	add	a1,a1,8 # 1008 <test_munmap_split+0x4>
{
    10f6:	e406                	sd	ra,8(sp)
	exit(main(argc, argv));
    10f8:	fe7ff0ef          	jal	10de <main>
    10fc:	3fd000ef          	jal	1cf8 <exit>
	return 0;
}
    ...
    110a:	f406                	sd	ra,40(sp)
{
    ...
    1114:	00001697          	auipc	a3,0x1
    1118:	f0468693          	add	a3,a3,-252 # 2018 <digits>
    buf[16] = 0;
    ...
    1244:	00001697          	auipc	a3,0x1
    1248:	dd468693          	add	a3,a3,-556 # 2018 <digits>
    buf[16] = 0;
    ...
    1370:	18bc                	add	a5,sp,120
{
    ...
    13a2:	c7a98993          	add	s3,s3,-902 # 2018 <digits>
        if (!*s)
    ...
    15dc:	a0840413          	add	s0,s0,-1528 # 1fe0 <__clone+0xe4>
...
size_t strlen(const char *s)
{
    ...
    18e8:	7045b583          	ld	a1,1796(a1) # 1fe8 <__clone+0xec>
    18ec:	00000617          	auipc	a2,0x0
    18f0:	70463603          	ld	a2,1796(a2) # 1ff0 <__clone+0xf4>
    ...
    1920:	00757713          	and	a4,a0,7
{
    ...
    1950:	6ac53503          	ld	a0,1708(a0) # 1ff8 <__clone+0xfc>
    ...
    1962:	68a8b883          	ld	a7,1674(a7) # 1fe8 <__clone+0xec>
    1966:	00000817          	auipc	a6,0x0
    196a:	68a83803          	ld	a6,1674(a6) # 1ff0 <__clone+0xf4>
    196e:	431d                	li	t1,7
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19ee:	5fe63603          	ld	a2,1534(a2) # 1fe8 <__clone+0xec>
    19f2:	00000817          	auipc	a6,0x0
    19f6:	5fe83803          	ld	a6,1534(a6) # 1ff0 <__clone+0xf4>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1a82:	56a8b883          	ld	a7,1386(a7) # 1fe8 <__clone+0xec>
    1a86:	00000817          	auipc	a6,0x0
    1a8a:	56a83803          	ld	a6,1386(a6) # 1ff0 <__clone+0xf4>
    1a8e:	431d                	li	t1,7
...
pid_t clone(int (*fn)(void *arg), void *arg, void *stack, size_t stack_size, unsigned long flags)
{
    ...
    1cec:	ac01                	j	1efc <__clone>

0000000000001cee <sys_clone_raw>:
}
...
0000000000001db0 <mprotect>:
    register long a7 __asm__("a7") = n;
    1db0:	0e200893          	li	a7,226
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2))
    1db4:	00000073          	ecall
...
0000000000001e1c <sys_linkat>:
    register long a4 __asm__("a4") = e;
    1e1c:	1702                	sll	a4,a4,0x20
    register long a7 __asm__("a7") = n;
    1e1e:	02500893          	li	a7,37
    register long a4 __asm__("a4") = e;
    1e22:	9301                	srl	a4,a4,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2), "r"(a3), "r"(a4))
    1e24:	00000073          	ecall
