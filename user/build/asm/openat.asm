...
/home/hbh/oslab/oslab/user/build/riscv64/openat:     file format elf64-littleriscv
...
void test_openat(void) {
    ...
    1026:	efe50513          	add	a0,a0,-258 # 1f20 <__clone+0x46>
    ...
    */
    ...
    108a:	f2250513          	add	a0,a0,-222 # 1fa8 <__clone+0xce>
    108e:	296000ef          	jal	1324 <puts>
    1092:	00001517          	auipc	a0,0x1
    1096:	f4650513          	add	a0,a0,-186 # 1fd8 <__func__.0>
    ...
    10a6:	e7e50513          	add	a0,a0,-386 # 1f20 <__clone+0x46>
}
    ...
    10b2:	ec250513          	add	a0,a0,-318 # 1f70 <__clone+0x96>
    ...
    10e8:	f406                	sd	ra,40(sp)
{
    ...
    10f6:	ef668693          	add	a3,a3,-266 # 1fe8 <digits>
    buf[16] = 0;
    ...
    1226:	dc668693          	add	a3,a3,-570 # 1fe8 <digits>
    buf[16] = 0;
    ...
    134e:	18bc                	add	a5,sp,120
{
    ...
    1380:	c6c98993          	add	s3,s3,-916 # 1fe8 <digits>
        if (!*s)
    ...
    15ba:	a0240413          	add	s0,s0,-1534 # 1fb8 <__clone+0xde>
...
size_t strlen(const char *s)
{
    ...
    18c6:	6fe5b583          	ld	a1,1790(a1) # 1fc0 <__clone+0xe6>
    18ca:	00000617          	auipc	a2,0x0
    18ce:	6fe63603          	ld	a2,1790(a2) # 1fc8 <__clone+0xee>
    ...
    18fe:	00757713          	and	a4,a0,7
{
    ...
    192e:	6a653503          	ld	a0,1702(a0) # 1fd0 <__clone+0xf6>
    ...
    1940:	6848b883          	ld	a7,1668(a7) # 1fc0 <__clone+0xe6>
    1944:	00000817          	auipc	a6,0x0
    1948:	68483803          	ld	a6,1668(a6) # 1fc8 <__clone+0xee>
    194c:	431d                	li	t1,7
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19cc:	5f863603          	ld	a2,1528(a2) # 1fc0 <__clone+0xe6>
    19d0:	00000817          	auipc	a6,0x0
    19d4:	5f883803          	ld	a6,1528(a6) # 1fc8 <__clone+0xee>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1a60:	5648b883          	ld	a7,1380(a7) # 1fc0 <__clone+0xe6>
    1a64:	00000817          	auipc	a6,0x0
    1a68:	56483803          	ld	a6,1380(a6) # 1fc8 <__clone+0xee>
    1a6c:	431d                	li	t1,7
...
pid_t clone(int (*fn)(void *arg), void *arg, void *stack, size_t stack_size, unsigned long flags)
{
    ...
    1cca:	ac01                	j	1eda <__clone>

0000000000001ccc <sys_clone_raw>:
}
...
0000000000001d8e <mprotect>:
    register long a7 __asm__("a7") = n;
    1d8e:	0e200893          	li	a7,226
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2))
    1d92:	00000073          	ecall
...
0000000000001dea <sys_mkdirat>:
    register long a2 __asm__("a2") = c;
    1dea:	1602                	sll	a2,a2,0x20
    register long a7 __asm__("a7") = n;
    1dec:	02200893          	li	a7,34
    register long a2 __asm__("a2") = c;
    1df0:	9201                	srl	a2,a2,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2))
    1df2:	00000073          	ecall
