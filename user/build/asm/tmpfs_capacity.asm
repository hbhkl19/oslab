...
/home/hbh/oslab/oslab/user/build/riscv64/tmpfs_capacity:     file format elf64-littleriscv
...
0000000000001004 <test_tmpfs_capacity>:
#include "string.h"
    ...
    100a:	f9a50513          	add	a0,a0,-102 # 1fa0 <__clone+0x28>
{
    ...
    101c:	06050513          	add	a0,a0,96 # 6078 <__func__.1>
    ...
    1030:	6609                	lui	a2,0x2
    1032:	00003697          	auipc	a3,0x3
    1036:	04668693          	add	a3,a3,70 # 4078 <bigbuf>
    103a:	4781                	li	a5,0
        bigbuf[i] = 'A' + (i % 26);
    103c:	45e9                	li	a1,26
    for(int i = 0; i < (int)sizeof(bigbuf) - 1; i++) {
    103e:	167d                	add	a2,a2,-1 # 1fff <__clone+0x87>
        bigbuf[i] = 'A' + (i % 26);
    1040:	02b7e73b          	remw	a4,a5,a1
    for(int i = 0; i < (int)sizeof(bigbuf) - 1; i++) {
    1044:	0685                	add	a3,a3,1
    1046:	2785                	addw	a5,a5,1
        bigbuf[i] = 'A' + (i % 26);
    1048:	0417071b          	addw	a4,a4,65
    104c:	fee68fa3          	sb	a4,-1(a3)
    for(int i = 0; i < (int)sizeof(bigbuf) - 1; i++) {
    1050:	fec798e3          	bne	a5,a2,1040 <test_tmpfs_capacity+0x3c>
    }
    bigbuf[sizeof(bigbuf) - 1] = '\0';

    int fd = open("tmpfs_big.txt", O_CREATE | O_RDWR);
    1054:	04200593          	li	a1,66
    1058:	00001517          	auipc	a0,0x1
    105c:	f7050513          	add	a0,a0,-144 # 1fc8 <__clone+0x50>
    bigbuf[sizeof(bigbuf) - 1] = '\0';
    1060:	00005797          	auipc	a5,0x5
    1064:	00078ba3          	sb	zero,23(a5) # 6077 <bigbuf+0x1fff>
    int fd = open("tmpfs_big.txt", O_CREATE | O_RDWR);
    1068:	475000ef          	jal	1cdc <open>
    106c:	842a                	mv	s0,a0
    printf("open fd: %d\n", fd);
    106e:	85aa                	mv	a1,a0
    1070:	00001517          	auipc	a0,0x1
    1074:	f6850513          	add	a0,a0,-152 # 1fd8 <__clone+0x60>
    1078:	36c000ef          	jal	13e4 <printf>
    assert(fd > 0);
    107c:	0c805863          	blez	s0,114c <test_tmpfs_capacity+0x148>

    int n = write(fd, bigbuf, sizeof(bigbuf));
    1080:	6609                	lui	a2,0x2
    1082:	00003597          	auipc	a1,0x3
    1086:	ff658593          	add	a1,a1,-10 # 4078 <bigbuf>
    108a:	8522                	mv	a0,s0
    108c:	48f000ef          	jal	1d1a <write>
    1090:	0005049b          	sext.w	s1,a0
    printf("write len: %d\n", n);
    1094:	85a6                	mv	a1,s1
    1096:	00001517          	auipc	a0,0x1
    109a:	f7250513          	add	a0,a0,-142 # 2008 <__clone+0x90>
    109e:	346000ef          	jal	13e4 <printf>
    assert(n == (int)sizeof(bigbuf));
    10a2:	6789                	lui	a5,0x2
    10a4:	00f48863          	beq	s1,a5,10b4 <test_tmpfs_capacity+0xb0>
    10a8:	00001517          	auipc	a0,0x1
    10ac:	f4050513          	add	a0,a0,-192 # 1fe8 <__clone+0x70>
    10b0:	5ae000ef          	jal	165e <panic>
    close(fd);
    10b4:	8522                	mv	a0,s0
    10b6:	44f000ef          	jal	1d04 <close>

    fd = open("tmpfs_big.txt", O_RDONLY);
    10ba:	4581                	li	a1,0
    10bc:	00001517          	auipc	a0,0x1
    10c0:	f0c50513          	add	a0,a0,-244 # 1fc8 <__clone+0x50>
    10c4:	419000ef          	jal	1cdc <open>
    10c8:	842a                	mv	s0,a0
    assert(fd > 0);
    10ca:	06a05a63          	blez	a0,113e <test_tmpfs_capacity+0x13a>
    static char readbuf[8192];
    int r = read(fd, readbuf, sizeof(readbuf));
    10ce:	6609                	lui	a2,0x2
    10d0:	00001597          	auipc	a1,0x1
    10d4:	fa858593          	add	a1,a1,-88 # 2078 <readbuf.0>
    10d8:	8522                	mv	a0,s0
    10da:	437000ef          	jal	1d10 <read>
    10de:	0005049b          	sext.w	s1,a0
    printf("read len: %d\n", r);
    10e2:	85a6                	mv	a1,s1
    10e4:	00001517          	auipc	a0,0x1
    10e8:	f3450513          	add	a0,a0,-204 # 2018 <__clone+0xa0>
    10ec:	2f8000ef          	jal	13e4 <printf>
    assert(r == (int)sizeof(readbuf));
    10f0:	6789                	lui	a5,0x2
    10f2:	00f48863          	beq	s1,a5,1102 <test_tmpfs_capacity+0xfe>
    10f6:	00001517          	auipc	a0,0x1
    10fa:	ef250513          	add	a0,a0,-270 # 1fe8 <__clone+0x70>
    10fe:	560000ef          	jal	165e <panic>
    close(fd);
    1102:	8522                	mv	a0,s0
    1104:	401000ef          	jal	1d04 <close>

    printf("tmpfs capacity success.\n");
    1108:	00001517          	auipc	a0,0x1
    110c:	f2050513          	add	a0,a0,-224 # 2028 <__clone+0xb0>
    1110:	2d4000ef          	jal	13e4 <printf>
    TEST_END(__func__);
    1114:	00001517          	auipc	a0,0x1
    1118:	f3450513          	add	a0,a0,-204 # 2048 <__clone+0xd0>
    111c:	2a6000ef          	jal	13c2 <puts>
    1120:	00005517          	auipc	a0,0x5
    1124:	f5850513          	add	a0,a0,-168 # 6078 <__func__.1>
    1128:	29a000ef          	jal	13c2 <puts>
}
...
int main(void)
{
    ...
    test_tmpfs_capacity();
    115e:	ea7ff0ef          	jal	1004 <test_tmpfs_capacity>
    return 0;
}
    ...
    1186:	f406                	sd	ra,40(sp)
{
    ...
    1190:	00005697          	auipc	a3,0x5
    1194:	f0068693          	add	a3,a3,-256 # 6090 <digits>
    buf[16] = 0;
    ...
    11a6:	0007c783          	lbu	a5,0(a5) # 2000 <__clone+0x88>
    } while ((x /= base) != 0);
    ...
    11c0:	00064603          	lbu	a2,0(a2) # 2000 <__clone+0x88>
    } while ((x /= base) != 0);
    ...
    12c0:	00005697          	auipc	a3,0x5
    12c4:	dd068693          	add	a3,a3,-560 # 6090 <digits>
    buf[16] = 0;
    ...
    13ec:	18bc                	add	a5,sp,120
{
    ...
    141a:	00005997          	auipc	s3,0x5
    141e:	c7698993          	add	s3,s3,-906 # 6090 <digits>
        if (!*s)
    ...
    1658:	a0440413          	add	s0,s0,-1532 # 2058 <__clone+0xe0>
...
size_t strlen(const char *s)
{
    ...
    1964:	7005b583          	ld	a1,1792(a1) # 2060 <__clone+0xe8>
    1968:	00000617          	auipc	a2,0x0
    196c:	70063603          	ld	a2,1792(a2) # 2068 <__clone+0xf0>
    ...
    199c:	00757713          	and	a4,a0,7
{
    ...
    19cc:	6a853503          	ld	a0,1704(a0) # 2070 <__clone+0xf8>
    ...
    19de:	6868b883          	ld	a7,1670(a7) # 2060 <__clone+0xe8>
    19e2:	00000817          	auipc	a6,0x0
    19e6:	68683803          	ld	a6,1670(a6) # 2068 <__clone+0xf0>
    19ea:	431d                	li	t1,7
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    1a6a:	5fa63603          	ld	a2,1530(a2) # 2060 <__clone+0xe8>
    1a6e:	00000817          	auipc	a6,0x0
    1a72:	5fa83803          	ld	a6,1530(a6) # 2068 <__clone+0xf0>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1afe:	5668b883          	ld	a7,1382(a7) # 2060 <__clone+0xe8>
    1b02:	00000817          	auipc	a6,0x0
    1b06:	56683803          	ld	a6,1382(a6) # 2068 <__clone+0xf0>
    1b0a:	431d                	li	t1,7
