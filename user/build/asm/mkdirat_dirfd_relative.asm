...
/home/hbh/oslab/oslab/user/build/riscv64/mkdirat_dirfd_relative:     file format elf64-littleriscv
...
0000000000001004 <test_mkdirat_dirfd_relative>:
#include "unistd.h"
#include "stdio.h"
#include "stdlib.h"
    ...
    100a:	f9a50513          	add	a0,a0,-102 # 1fa0 <__clone+0x28>
{
    ...
    TEST_START(__func__);
    1014:	3ae000ef          	jal	13c2 <puts>
    1018:	00001517          	auipc	a0,0x1
    101c:	09850513          	add	a0,a0,152 # 20b0 <__func__.0>
    1020:	3a2000ef          	jal	13c2 <puts>
    1024:	00001517          	auipc	a0,0x1
    1028:	f9450513          	add	a0,a0,-108 # 1fb8 <__clone+0x40>
    102c:	396000ef          	jal	13c2 <puts>

    int ret = mkdir("mkdirat_base", 0666);
    1030:	1b600593          	li	a1,438
    1034:	00001517          	auipc	a0,0x1
    1038:	f9450513          	add	a0,a0,-108 # 1fc8 <__clone+0x50>
    103c:	6d9000ef          	jal	1f14 <mkdir>
    1040:	842a                	mv	s0,a0
    printf("mkdir base ret: %d\n", ret);
    1042:	85aa                	mv	a1,a0
    1044:	00001517          	auipc	a0,0x1
    1048:	f9450513          	add	a0,a0,-108 # 1fd8 <__clone+0x60>
    104c:	398000ef          	jal	13e4 <printf>
    assert(ret == 0 || ret == -1);
    1050:	2405                	addw	s0,s0,1
    1052:	4785                	li	a5,1
    1054:	0087f863          	bgeu	a5,s0,1064 <test_mkdirat_dirfd_relative+0x60>
    1058:	00001517          	auipc	a0,0x1
    105c:	f9850513          	add	a0,a0,-104 # 1ff0 <__clone+0x78>
    1060:	5fe000ef          	jal	165e <panic>

    int dfd = open("mkdirat_base", O_RDONLY | O_DIRECTORY);
    1064:	002005b7          	lui	a1,0x200
    1068:	00001517          	auipc	a0,0x1
    106c:	f6050513          	add	a0,a0,-160 # 1fc8 <__clone+0x50>
    1070:	46d000ef          	jal	1cdc <open>
    1074:	842a                	mv	s0,a0
    printf("dir fd: %d\n", dfd);
    1076:	85aa                	mv	a1,a0
    1078:	00001517          	auipc	a0,0x1
    107c:	f9850513          	add	a0,a0,-104 # 2010 <__clone+0x98>
    1080:	364000ef          	jal	13e4 <printf>
    assert(dfd > 0);
    1084:	0c805463          	blez	s0,114c <test_mkdirat_dirfd_relative+0x148>

    ret = sys_mkdirat(dfd, "child", 0666);
    1088:	00001597          	auipc	a1,0x1
    108c:	f9858593          	add	a1,a1,-104 # 2020 <__clone+0xa8>
    1090:	1b600613          	li	a2,438
    1094:	8522                	mv	a0,s0
    1096:	5f3000ef          	jal	1e88 <sys_mkdirat>
    109a:	84aa                	mv	s1,a0
    printf("mkdirat ret: %d\n", ret);
    109c:	85aa                	mv	a1,a0
    109e:	00001517          	auipc	a0,0x1
    10a2:	f8a50513          	add	a0,a0,-118 # 2028 <__clone+0xb0>
    10a6:	33e000ef          	jal	13e4 <printf>
    assert(ret == 0);
    10aa:	e8d1                	bnez	s1,113e <test_mkdirat_dirfd_relative+0x13a>
    close(dfd);
    10ac:	8522                	mv	a0,s0
    10ae:	457000ef          	jal	1d04 <close>

    ret = chdir("mkdirat_base");
    10b2:	00001517          	auipc	a0,0x1
    10b6:	f1650513          	add	a0,a0,-234 # 1fc8 <__clone+0x50>
    10ba:	64f000ef          	jal	1f08 <chdir>
    10be:	842a                	mv	s0,a0
    printf("chdir ret: %d\n", ret);
    10c0:	85aa                	mv	a1,a0
    10c2:	00001517          	auipc	a0,0x1
    10c6:	f7e50513          	add	a0,a0,-130 # 2040 <__clone+0xc8>
    10ca:	31a000ef          	jal	13e4 <printf>
    assert(ret == 0);
    10ce:	e02d                	bnez	s0,1130 <test_mkdirat_dirfd_relative+0x12c>

    int fd = open("child", O_RDONLY | O_DIRECTORY);
    10d0:	002005b7          	lui	a1,0x200
    10d4:	00001517          	auipc	a0,0x1
    10d8:	f4c50513          	add	a0,a0,-180 # 2020 <__clone+0xa8>
    10dc:	401000ef          	jal	1cdc <open>
    10e0:	842a                	mv	s0,a0
    if(fd > 0) {
    10e2:	04a05063          	blez	a0,1122 <test_mkdirat_dirfd_relative+0x11e>
        printf("dirfd mkdirat success.\n");
    10e6:	00001517          	auipc	a0,0x1
    10ea:	f6a50513          	add	a0,a0,-150 # 2050 <__clone+0xd8>
    10ee:	2f6000ef          	jal	13e4 <printf>
        close(fd);
    10f2:	8522                	mv	a0,s0
    10f4:	411000ef          	jal	1d04 <close>
    } else {
    ...
    10fc:	f8850513          	add	a0,a0,-120 # 2080 <__clone+0x108>
    1100:	2c2000ef          	jal	13c2 <puts>
    1104:	00001517          	auipc	a0,0x1
    1108:	fac50513          	add	a0,a0,-84 # 20b0 <__func__.0>
    110c:	2b6000ef          	jal	13c2 <puts>
}
    ...
    111a:	ea250513          	add	a0,a0,-350 # 1fb8 <__clone+0x40>
}
    111e:	6105                	add	sp,sp,32
    TEST_END(__func__);
    1120:	a44d                	j	13c2 <puts>
        printf("dirfd mkdirat failed.\n");
    1122:	00001517          	auipc	a0,0x1
    1126:	f4650513          	add	a0,a0,-186 # 2068 <__clone+0xf0>
    112a:	2ba000ef          	jal	13e4 <printf>
    112e:	b7e9                	j	10f8 <test_mkdirat_dirfd_relative+0xf4>
    assert(ret == 0);
    1130:	00001517          	auipc	a0,0x1
    1134:	ec050513          	add	a0,a0,-320 # 1ff0 <__clone+0x78>
    1138:	526000ef          	jal	165e <panic>
    113c:	bf51                	j	10d0 <test_mkdirat_dirfd_relative+0xcc>
    assert(ret == 0);
    113e:	00001517          	auipc	a0,0x1
    1142:	eb250513          	add	a0,a0,-334 # 1ff0 <__clone+0x78>
    1146:	518000ef          	jal	165e <panic>
    114a:	b78d                	j	10ac <test_mkdirat_dirfd_relative+0xa8>
    assert(dfd > 0);
    114c:	00001517          	auipc	a0,0x1
    1150:	ea450513          	add	a0,a0,-348 # 1ff0 <__clone+0x78>
    1154:	50a000ef          	jal	165e <panic>
    1158:	bf05                	j	1088 <test_mkdirat_dirfd_relative+0x84>
...
int main(void)
{
    ...
    115e:	ea7ff0ef          	jal	1004 <test_mkdirat_dirfd_relative>
    return 0;
}
    ...
    116c:	4108                	lw	a0,0(a0)
{
	...
	exit(main(argc, argv));
    1170:	05a1                	add	a1,a1,8 # 200008 <digits+0x1fdf38>
{
    ...
    1186:	f406                	sd	ra,40(sp)
{
    ...
    1194:	f4068693          	add	a3,a3,-192 # 20d0 <digits>
    buf[16] = 0;
    ...
    12c4:	e1068693          	add	a3,a3,-496 # 20d0 <digits>
    buf[16] = 0;
    ...
    13ec:	18bc                	add	a5,sp,120
{
    ...
    141e:	cb698993          	add	s3,s3,-842 # 20d0 <digits>
        if (!*s)
    ...
    1658:	a3c40413          	add	s0,s0,-1476 # 2090 <__clone+0x118>
...
size_t strlen(const char *s)
{
    ...
    1964:	7385b583          	ld	a1,1848(a1) # 2098 <__clone+0x120>
    1968:	00000617          	auipc	a2,0x0
    196c:	73863603          	ld	a2,1848(a2) # 20a0 <__clone+0x128>
    ...
    199c:	00757713          	and	a4,a0,7
{
    ...
    19cc:	6e053503          	ld	a0,1760(a0) # 20a8 <__clone+0x130>
    ...
    19de:	6be8b883          	ld	a7,1726(a7) # 2098 <__clone+0x120>
    19e2:	00000817          	auipc	a6,0x0
    19e6:	6be83803          	ld	a6,1726(a6) # 20a0 <__clone+0x128>
    19ea:	431d                	li	t1,7
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    1a6a:	63263603          	ld	a2,1586(a2) # 2098 <__clone+0x120>
    1a6e:	00000817          	auipc	a6,0x0
    1a72:	63283803          	ld	a6,1586(a6) # 20a0 <__clone+0x128>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1afe:	59e8b883          	ld	a7,1438(a7) # 2098 <__clone+0x120>
    1b02:	00000817          	auipc	a6,0x0
    1b06:	59e83803          	ld	a6,1438(a6) # 20a0 <__clone+0x128>
    1b0a:	431d                	li	t1,7
