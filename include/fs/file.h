...
#define FD_DEVICE   3
#define FD_PIPE     4
#define FD_FAT32    5   // FAT32 文件
#define FD_TMPFS    6   // 内存文件 (tmpfs)

// 每个进程最多打开的文件数量
#define FILE_PER_PROC 128
...
typedef struct file {
    ...
    // FAT32 文件信息
    uint32 fat32_cluster;  // FAT32 起始簇号
    uint32 fat32_size;     // FAT32 文件大小
...
file_t* file_open_fat32(const char* path, uint32 open_mode);  // FAT32 文件打开
